...
public class VehiculeController {
	...
	@PutMapping("/update")
	public ResponseEntity<Vehicule> updateVehicule(Vehicule vehicule) {
		vehicule = this.vehiculeService.update(vehicule);
		return new ResponseEntity<Vehicule>(vehicule, HttpStatus.OK);
	}
	...
	@GetMapping("/{type}")
	public ResponseEntity<List<Vehicule>> getVehiculesByType( String type) {
		List<Vehicule> vehicules  = this.vehiculeService.findByType(type);
		return new ResponseEntity<>(vehicules, HttpStatus.OK);
	}

	// Rechercher un vehicule par nombrePlaces
	@GetMapping("/{nombrePlaces}")
	public ResponseEntity<List<Vehicule>> getVehiculesByNombrePlaces(int nombrePlaces) {
